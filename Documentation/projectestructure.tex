...
%    \textbf{\textit{Docker network scheme:}}
    \begin{center}
    \includegraphics[scale=0.9]{NetworkDistribution}
    \end{center}
    \newpage
    ...
    \begin{flushleft}
        Taking a look in the main server, we can see that the docker machines are mainly distributed among a common network, while there still a       .
    \end{flushleft}
